...
export sync_path="openEuler-RISC-V/development/mainline/supplementary"
...
export meta_gen_command="createrepo --update $working_directory/public/$sync_path/$sync_name/ $comps_command $log_command"
