...
- obs submit package提交到哪个工程？
  ...
  - 建议：是否建立CI，让修包人员关注代码修复与PR，PR之后的obs submit可以简化？
...
- 5月初：RISC-V 软件源更新机、每日镜像构建完成；
- 5月底：完成版本滚动测试；
- 6月：完成所有failed包的修复；
- 7月：riscv64、x86、arm  3架构构建能力



讨论：

- 是否建立PR to obs submit的CI，让修包人员关注代码修复与PR，PR之后的obs submit可以简化？https://gitee.com/openeuler/RISC-V/issues/I54Y4U?from=project-issue



todo：

- RISC-V 软件源&每日镜像 现状的总体介绍
